    ...
    let befolkningsChart = new Chart(myChart, {
        ...
        data: {
            ...
            datasets: [{
                    ...
                    data: data.menF,
                    backgroundColor: '#6E64FF',
                    borderColor: '#6E64FF',
                },
                {
                    label: 'Antal födda kvinnor i Dalarna',
                    data: data.womenF,
                    backgroundColor: '#FF73F0',
                    borderColor: '#FF73f0',
                },
                {
                    label: 'Antal avlidna män i Dalarna',
                    data: data.menD,
                    backgroundColor: '#4C45B6',
                    borderColor: '#4C45B6',
                },
                {
                    label: 'Antal avlidna kvinnor i Dalarna',
                    data: data.womenD,
                    backgroundColor: '#B645AA',
                    borderColor: '#B645AA',
                }
            ]
        },
